...
public class LoginPage {
	...
	public void sendVerificationCode(String value) {
		driver.manage().timeouts().implicitlyWait(5,TimeUnit.SECONDS);
		driver.findElementByCssSelector(this.verificationCode).clear();
		driver.findElementByCssSelector(this.verificationCode).sendKeys(value);
	}
	...
	public void sendVerificationCode() throws IOException{
		...
		driver.manage().timeouts().implicitlyWait(5,TimeUnit.SECONDS);
		driver.findElementByCssSelector(this.verificationCode).sendKeys(line);
